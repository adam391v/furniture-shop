...
// ============================================================
// Admin - Quản lý Sản phẩm: Danh sách + CRUD
// Bảng dữ liệu với tìm kiếm, sắp xếp, xóa, sửa
// ============================================================
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-text-secondary mt-1">{mockProducts.length} sản phẩm</p>
        </div>
        <Link
                ...
                <tr key={product.id} className="hover:bg-bg-secondary/50 transition-colors">
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-text-muted">{mockCategories.find(c => c.id === product.categoryId)?.name || 'Chưa phân loại'}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <button
                        onClick={() => setShowDeleteModal(product.id as number)}
              ...
              <button
                ...
                className={cn(
                  ...
                  page === currentPage
                    ...
                    : 'hover:bg-bg-secondary text-navy'
                )}
              >
                {page}
              </button>
